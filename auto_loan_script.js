(function () {
  ...
  function calculate() {
    ...
    let taxablePrice =
      state.price - state.incentives - state.down - state.tradeVal;
    ...
    const upfrontPayment =
      state.down + state.incentives + salesTax + state.fees;
  ...
  function renderSchedule() {
    ...
    for (let y = 1; y <= years; y++) {
      ...
      const yPrincipal = yearSlice.reduce(
